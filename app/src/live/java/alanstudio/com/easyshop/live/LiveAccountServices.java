...
import alanstudio.com.easyshop.activities.LoginActivity;
...
public class LiveAccountServices extends BaseLiveServices {
    ...
    public LiveAccountServices(EasyShoppingApplication application) {
        super(application);
    }
    ...
    public void RegisterUser(final AccountServices.RegisterUserRequest request){
        ...
        if (response.didSucceed()){
            ...
            //create random user password for first register
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (!task.isSuccessful()){
                                                    ...
                                                    DatabaseReference reference = FirebaseDatabase.getInstance()
                                                            .getReferenceFromUrl(Utils.FIREBASE_USER_REF + Utils.encodeEmail(request.userEmail));
                                                    ...
                                                    Toast.makeText(application.getApplicationContext(), "Please check email", Toast.LENGTH_LONG).show();

                                                    request.progressDialog.dismiss();

                                                    Intent intent = new Intent(application.getApplicationContext(), LoginActivity.class);
                                                    //call flags so that the user cannot go back. The equivalent of finish.
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                userLocation.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        ...
                                        //adding user credentials to shared preferences
                                        if (user!=null){
    ...
    @Subscribe
    public void FacebookLogin(final AccountServices.LoginUserInFacebookRequest request) {
        request.progressDialog.show();
